...
const CartPage: React.FC = () => {
  ...
  return (
    <div className="w-full h-auto px-4 sm:px-5 md:px-15 lg:px-25 py-4 md:py-10 bg-gray-50 min-h-screen">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 h-fit">
          ...
          <Link to="/checkout">
            <button
              ...
              className="w-full mb-3 bg-yellow-500 text-white py-3 px-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed"
            >
              Proceed to Checkout
            </button>
          </Link>
